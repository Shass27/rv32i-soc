...
module tb_control_unit;
    ...
    initial begin
        ...
        check({25'd0, 7'b0110011}, 1, 0, 0, 0, 0, 0, 0, 0, 2'b10, "R-type");
        check({25'd0, 7'b0010011}, 1, 1, 0, 0, 0, 0, 0, 0, 2'b10, "ADDI   ");
        check({25'd0, 7'b0000011}, 1, 1, 1, 0, 1, 0, 0, 0, 2'b00, "LW     ");
        check({25'd0, 7'b0100011}, 0, 1, 0, 1, 0, 0, 0, 0, 2'b00, "SW     ");
        check({25'd0, 7'b1100011}, 0, 0, 0, 0, 0, 1, 0, 0, 2'b01, "BEQ    ");
        check({25'd0, 7'b1101111}, 1, 0, 0, 0, 0, 0, 1, 0, 2'b00, "JAL    ");
        check({25'd0, 7'b1100111}, 1, 0, 0, 0, 0, 0, 0, 1, 2'b00, "JALR   ");
